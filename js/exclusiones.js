function cargarPaginaExclusiones() {
    ...
    function renderizarExclusiones() {
        ...
        pagIzquierda.innerHTML = `
            ...
            <div class="bg-white/60 p-2 border-4 border-black shadow-[4px_4px_0_#000] mb-2">
            ...
            <div class="mt-2 pt-2 border-t-4 border-black bg-[#f4ebd0] z-10">
        ...
        pagDerecha.innerHTML = `
            ...
            <div class="bg-red-100 p-1.5 border-4 border-black shadow-[4px_4px_0_rgba(0,0,0,1)] mb-2 text-center">
